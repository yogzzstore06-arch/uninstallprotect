...
echo "🚀 Uninstall Proteksi Anti Modifikasi Detail Nodes 3..."
...
echo "✅ Uninstall Proteksi Anti Modifikasi Detail Nodes 3 berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"/bash

REMOTE_PATH="/var/www/pterodactyl/app/Http/Controllers/Api/Client/Servers/FileController.php"
TIMESTAMP=$(date -u +"%Y-%m-%d-%H-%M-%S")

echo "🚀 Uninstall Proteksi Anti Akses Server 1..."
...
# Atur permission file
chmod 644 "$REMOTE_PATH"
echo "✅ Uninstall Proteksi Server Akses 1 berhasil dipasang!"
